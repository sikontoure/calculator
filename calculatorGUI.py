...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clearButton.setGeometry(QtCore.QRect(30, 460, 161, 91))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.equalButton.setText(_translate("MainWindow", "Equal"))
        self.zeroButton.setText(_translate("MainWindow", "0"))
        self.decimalButton.setText(_translate("MainWindow", "."))
        self.multiplyButton.setText(_translate("MainWindow", "Multiplication"))
        self.subtractButton.setText(_translate("MainWindow", "Subtraction"))
        self.addButton.setText(_translate("MainWindow", "Addition"))
